...
Увидел когда-то давно
<a href="https://realt.onliner.by/2021/06/12/20-krutyx-mest-dlya-progulok">статью</a> на онлайнере.
И вот спустя месяц с лишним созрел посмотреть места из статьи.
...
В общем, я нашёл, чем заполнять выходные ~~не всё за компом сидеть~~. Удивило меня в себе то, что
...
привык (пришлось, правда, прилагу для ПДД с неделю использовать, чтобы освежить знания). От шеринга
...
интернетом — вообще не работает. ~~Не читал, но~~ осуждаю.
